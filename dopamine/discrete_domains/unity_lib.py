...
def create_otc_environment(environment_path=None):
  ...
  env = ObstacleTowerEnv(environment_path, 0, retro = True, realtime_mode=True)
...
#   """
#   print("FIVEIVIEIFIVEIIEFIFEIVIEIFIIVE")
...
#
#   print("RAINOE RIANEOFNOWFOWEFOWDNKDJF")
#   print(state.shape)
#   net = tf.cast(state, tf.float32)
#   net = tf.div(net, 255.)
#   net = slim.conv2d(
...
#   """
#   print(7)
#   print("LAKFJLAKSJFOWJFOWKJFSDL:FJDSFK:S")
#   weights_initializer = slim.variance_scaling_initializer(
#       factor=1.0 / np.sqrt(3.0), mode='FAN_IN', uniform=True)
#
